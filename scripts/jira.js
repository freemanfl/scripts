chrome.storage.sync.get("jira", function (data) {
  if (data.jira) {
    ...
    const markets = [
      ...
      {
        full: "Ford of Luxembourg",
        domain: "lu",
        folder: ["fr_lu"],
        beta: false,
      },
      {
        full: "Ford of Netherlands",
        domain: "nl",
        folder: ["nl_nl"],
        beta: true,
      },
    ...
    container.innerHTML = `
            ...
            <div class="ball" id="live">
              <a href="#">LIVE</a>
            </div>

            <div class="ball" id="perf">
              <a href="#">PERF</a>
            </div>

            <div class="ball" id="touch">
              <a href="#">TOUCH</a>
              <div id="touchLoader" class="loader"></div>
            </div>
          </div>
          ...
          <div id="copyContainer">
            <div class="tooltipp">
              <button class="copy" id="copy">
                <span class="tooltipptext" id="myTooltip">Copy to clipboard</span>
                &#128203;
              </button>
            </div>
            <div class="tooltipp">
              <button class="copy" id="copyContent">
                <span class="tooltipptext" id="myTooltip2">Copy from "/content"</span
                >/content...
              </button>
            </div>
          </div>
    ...
    const jiraBody = document.querySelector("#page");

    jiraBody.appendChild(container);

    container = document.querySelector("#uiCont");
    var copyButton = container.querySelector("#copy");
    var copyContentButton = container.querySelector("#copyContent");
    var copyDiv = container.querySelector("#destination");
    ...
    async function sendGreetings() {
      ...
      var loader = container.querySelector("#touchLoader");
      ...
      touchB.href =
        "https://wwwperf.brandeuauthorlb.ford.com/editor.html" +
        response.farewell;
      ...
      touchB.addEventListener("mouseover", () => {
        container.querySelector("#destination").innerText = touchB.href;
      });
    ...
    async function sendGreetingsFromTouch(id) {
      ...
      var liveB = container.querySelector("#live").getElementsByTagName("a")[0];
      ...
      liveB.addEventListener("mouseover", () => {
        container.querySelector("#destination").innerText = liveB.href;
      });
    }
    ...
    async function sendGreetingsFromTouchToPerf(id) {
      ...
      var perfB = container.querySelector("#perf").getElementsByTagName("a")[0];
      ...
      if (currentEnv.domain == "co.uk") {
        ...
        perfB.addEventListener("mouseover", () => {
          container.querySelector("#destination").innerText = perfB.href;
        });
      } else {
        perfB.href =
          currentEnv.url.split("perf")[0] +
        ...
        if (currentEnv.dam) {
          if (currentEnv.domain == "co.uk") {
            ...
            perfB.addEventListener("mouseover", () => {
              document
                .querySelector("#uiCont")
                .querySelector("#destination").innerText = perfB.href;
            });
          } else {
            perfB.href = url.replace(
              `.ford.${currentEnv.domain}`,
    ...
    for (var i = 0; i < allLinks.length; i++) {
      if (allLinks[i].href.includes("ford")) {
        allLinks[i].addEventListener("mouseenter", (event) => {
          ...
          timeout = setTimeout(() => {
            ...
            currentEnv.url = event.target.href;
        ...
        allLinks[i].addEventListener("mouseleave", (event) => {
          console.log(timeout);
